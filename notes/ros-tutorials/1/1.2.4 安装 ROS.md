...
![00ROS安装之ubuntu准备.png "00ROS安装之ubuntu准备"](./1100ROS安装之ubuntu准备.png "00ROS安装之ubuntu准备")
...
友情提示: 由于网络原因,导致连接超时，可能会安装失败，如下所示:![09_安装异常.PNG "09\_安装异常"](./1109_安装异常.PNG "09\_安装异常")可以多次重复调用 更新 和 安装命令，直至成功。
...
![rosdep正常初始化.PNG](./11rosdep正常初始化.PNG)


![rosdep正常更新.PNG](./11rosdep正常更新.PNG)
...
**问题:**![noetic异常提示.PNG](./11noetic异常提示.PNG)
...
```
![noetic_查找包含githubusercontent的文件.PNG](./11noetic_查找包含githubusercontent的文件.PNG)
