...
添加完毕后，选择 file \-\-\-\> Save World as 选择保存路径(功能包下: worlds 目录)，文件名自定义，后缀名设置为 .world![14_gazebo保存为world文件.png](./1114_gazebo保存为world文件.png)
...
![12_gazebo搭建环境.png](./1112_gazebo搭建环境.png)![13_gazebo构建环境.png](./1113_gazebo构建环境.png)
...
![14_gazebo保存为world文件.png](./1114_gazebo保存为world文件.png)
